    ...
    return when {
        parts[0] == "help" -> Command.Help(
            "-- help - помощь по программе.)\n" +
                    "-- show - показывает все телефоны и email введённого userName.)\n" +
                    "-- find - показывает всех людей, у которых записан введённый телефон или email.)\n" +
                    "-- add userName phone numberPhone - добавить пользователю номер телефона.)\n" +
                    "-- add userName email emailAddress - добавить пользователю адрес электронной почты.)\n" +
                    "-- export userName - экспортирует данные по пользователю в json-файл с его именем.)\n" +
